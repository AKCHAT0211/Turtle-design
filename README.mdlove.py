...
def curve():
    draw.pen(pencolor="Black", pensize=3, speed=8)
    for i in range(200):
        draw.rt(1)
        draw.fd(1)

def heart():
    draw.pen(pencolor="black",fillcolor="red", pensize=3, speed=2)
    draw.shape("turtle")
...
draw.pen(pencolor="black",fillcolor="white", pensize=3, speed=8)
